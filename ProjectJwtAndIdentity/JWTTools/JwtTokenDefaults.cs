...
public class JwtTokenDefaults
{
    ...
    public const string Key = ""; //bu token için bir tane key verelim, bu key bizim tokenı aslında kendi localimde kendine ait şifresi olacak ve bu keyin uzun olması gerekiyor. 
